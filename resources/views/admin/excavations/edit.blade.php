...
@section('title')
    {{ __('messages.Edit') }} {{ __('messages.excavations') }}
@endsection



@section('contentheaderlink')
    <a href="{{ route('excavations.index') }}"> {{ __('messages.excavations') }} </a>
@endsection
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title card_title_center"> {{ __('messages.Edit') }} {{ __('messages.excavations') }} </h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                ...
                <form action="{{ route('excavations.update', $data['id']) }}" method="POST" enctype='multipart/form-data'>
                    <div class="row">
                    @csrf
                    @method('PUT')
